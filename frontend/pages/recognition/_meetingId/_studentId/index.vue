<template>
  <CardRecognition
    ...
    :title="['Detail', 'Overview', 'Summary']"
    :data="data"
    :name="individual?.user?.name"
    :meeting="individual?.meeting?.code"
    :is-show-image="true"
    :is-simple-mode="isSimpleMode"
    @simple-toggle="simpleToggle"
    @refresh="fetchIndividualData"
  />
</template>
...
export default {
  name: 'RecognitionMeetingIdStudentIdPage',
  middleware: 'auth',
  data() {
    return {
      isLoading: false,
      ...
      return [
        ...
        },
        {
          ...
          to: {
            ...
            params: { meetingId: this.$route.params.meetingId },
          },
        },
        {
